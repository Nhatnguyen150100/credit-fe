      ...
      <>
        <div className="rounded-b-3xl pb-7">
          ...
          <p className="text-sm leading-relaxed text-secondary-link">
            Hiện tại bạn chưa có khoản vay nào đang chờ xét duyệt trong hệ
            thống.
          </p>
        </div>
        ...
        <div className="space-y-4">
          <div className="rounded-2xl bg-white px-4 py-4 shadow-sm text-center">
            <div className="flex flex-col items-center mb-4">
              ...
              <p className="text-sm text-secondary-link leading-relaxed max-w-[320px]">
                Bạn chưa có khoản vay nào được ghi nhận và đang chờ xét duyệt
                trong hệ thống. Vui lòng thực hiện đăng ký khoản vay mới để bắt
                đầu quy trình.
              </p>
            </div>
          </div>
          ...
          <div className="rounded-2xl bg-theme-sand-light px-4 py-4 text-sm leading-relaxed text-text-color">
            ...
            <p className="mb-2">
              Để đăng ký khoản vay mới và bắt đầu quy trình xét duyệt, vui lòng
            ...
            <p className="mb-1">
              Sau khi đăng ký thành công, khoản vay của bạn sẽ được ghi nhận và
              hiển thị tại trang này với trạng thái "Đang chờ xét duyệt".
            </p>
            <p className="m-0">
              Nếu có bất kỳ thắc mắc nào, vui lòng liên hệ đội ngũ chăm sóc
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-secondary-link leading-relaxed">
                  Thời gian xét duyệt thường từ 1-3 ngày làm việc. Bạn sẽ nhận
                  được thông báo ngay khi có kết quả xét duyệt qua số điện thoại
                  đã đăng ký.
                </p>
              </div>
            </div>
    ...
    <>
      ...
      <div className="space-y-4">
        <div className="rounded-2xl bg-white px-4 py-4 shadow-sm">
          ...
          <div className="mt-4 space-y-3 text-sm">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="font-medium text-text-color">Chờ xét duyệt</span>
            </div>
            <Visibility visibility={user?.phone_number}>
              <div className="flex items-center justify-between">
        ...
        <div className="rounded-2xl bg-theme-sand-light px-4 py-4 text-sm leading-relaxed text-text-color">
          ...
          <p className="mb-1">
            Vui lòng kiểm tra thông tin và chờ phản hồi từ hệ thống. Bạn sẽ nhận
            được thông báo khi có kết quả xét duyệt.
          </p>
          <p className="m-0">
