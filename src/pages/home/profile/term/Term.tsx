          ...
          <ol className="list-decimal pl-6 space-y-4">
            <li>
              ...
              <ol className="list-decimal pl-6 space-y-2">
                ...
                <li>
                  <strong>Sử dụng dịch vụ bên thứ ba:</strong> Bạn thừa nhận
                  rằng khi đồng ý với Chính sách này, Bạn đang sử dụng Ứng dụng
            ...
            <li>
              ...
              <ol className="list-decimal pl-6 space-y-2">
                <li>
                  <strong>Quy định thu thập thông tin:</strong> Chính sách này
                  quy định cách mà Yoshi Credit thu thập, sử dụng, bảo vệ và chia
                  sẻ thông tin.
                </li>
                <li>
              ...
              <ol className="list-decimal pl-6 space-y-2">
                <li>
                  ...
                  <ol className="list-decimal pl-6 space-y-2">
                    ...
                    <li>
                      <strong>Thông tin phi cá nhân:</strong> Thông tin không
                      xác định Bạn cá nhân như giới tính.
                    </li>
                  </ol>
                </li>
                <li>
            ...
            <li>
              ...
              <ol className="list-decimal pl-6 space-y-2">
                ...
                <li>
                  ...
                  <ol className="list-decimal pl-6 space-y-2">
                    <li>
                      <strong>Tạo Tài khoản:</strong> Để tạo và bảo mật Tài
                      khoản người dùng.
                    </li>
                    <li>
